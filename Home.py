...
def app():
    ...
    #st.header("Talent Analytics Chatbot")
    st.write("""Welcome to the Talent Analytics Chatbot. I am an intelligent chatbot created by combining the strengths of Langchain and Streamlit. I use large language models to provide context-sensitive interactions. My goal is to help you better understand your data.
