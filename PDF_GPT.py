...
def get_conversation_chain(vectorstore):
    ...
    prompt_template = """
    You are an intelligent AI which analyses text from documents, pdfs and answers the user's questions. Please answer in as much detail as possible, so that the user does not have to 
    ...
    llm = ChatOpenAI(
            ...
            openai_api_key="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",
